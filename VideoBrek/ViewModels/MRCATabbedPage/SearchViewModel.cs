            ...
            try
            {
                Device.BeginInvokeOnMainThread(async () =>
                {
                    ...
                    if (VideoMediaStreamInfos.Muxed.FirstOrDefault() != null)
                    {
                        ...
                        //allMediaModel.Id = searchMediaModel.MediaID;
                        //allMediaModel.Title = searchMediaModel.Title;
                        //allMediaModel.Description = searchMediaModel.MediaDesc;
                        //allMediaModel.CloudUrl = searchMediaModel.ClickURL;
                        //allMediaModel.ThumbURL = searchMediaModel.Thumbnail;
                        //await Navigation.PushModalAsync(new NavigationPage(new Views.MediaDetails.MediaDetails(allMediaModel)));
                    });
